...
BUSINESS_GLOSSARY: list[GlossaryEntry] = [
    ...
    GlossaryEntry("margin", "profit",
                  "Profit expressed as a percentage of revenue (profit / revenue * 100). Same data "
                  "requirement as profit."),
    GlossaryEntry("quantity", "quantity",
                  "A count of units, items, or orders -- not a monetary amount. Often stored as "
                  "'quantity', 'units_sold', or 'qty'."),
    GlossaryEntry("order", "quantity",
